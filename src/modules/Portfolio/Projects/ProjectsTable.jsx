...
const ProjectsTable = () => {
    return (
        <table className="min-w-full h-screen divide-y-2 divide-gray-200 bg-white text-sm">
            <thead>
                <tr>
            ...
            <tbody className="divide-y divide-gray-200 cursor-default">
                {dummyData.map((data, index) => (
                    <tr key={index}>
                        <td className="px-4 py-2 whitespace-nowrap text-brand-900">{data.name}</td>
                        ...
                        <td className="px-4 py-2 whitespace-nowrap text-gray-900">{data.status}</td>
                        <td className="px-4 py-2 whitespace-nowrap text-gray-900">
