import useVerifyEmail from "@/forms/formComponents/registration/hooks/useEmailVerificationForm";
import FormField from "@/forms/formComponents/common/FormField";
import FormButton from "@/forms/formComponents/common/FormButton";
import InitialForm from "@/forms/formComponents/common/InitialForm";
import FormGeneralError from "@/forms/formComponents/common/FormGeneralError";

const Step2EmailVerification = () => {
    const { onSubmit, handleSubmit, register, loading, generalError, errors } = useVerifyEmail();
