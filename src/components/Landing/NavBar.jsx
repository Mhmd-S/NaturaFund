...
const NavBar = () => {
    return (
        <div className="absolute z-10 top-0 w-screen p-2 grid grid-cols-3 grid-rows-1 items-center place-self-center justify-self-center text-white backdrop-blur-xl">
