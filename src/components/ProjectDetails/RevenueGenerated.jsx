...
const RevenueGenerated = () => {
    return (
        <div className="col-span-2 grid grid-cols-2 gap-2">
            <h2 className="col-span-2 text-3xl py-4 font-semibold text-center">
                Revenue Generated
            </h2>
