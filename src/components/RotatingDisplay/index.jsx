...
const RotatingDisplay = () => {
    return (
        <div className="relative w-full h-full overflow-hidden bg-brand-800 text-white py-1 col-start-2 col-span-full">
            <p className="absolute top-0 left-0 overflow-x-hidden w-max h-full flex flex-col justify-center items-center animate-rotatingDisplay">
