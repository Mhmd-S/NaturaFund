...
const ProjectCard = ({ project }) => {
    return (
        <div className="w-full h-full p-2 flex flex-col gap-y-6 justify-evenly items-center border-[1px] border-gray-light rounded-lg shadow-sm">
            ...
            <button className="flex items-center justify-center rounded-md transition-all bg-brand-800 p-2 border-2 text-white hover:text-brand-800 md:transition-all md:hover:bg-white md:border-brand-800">
                View Project
            </button>
        </div>
    );
